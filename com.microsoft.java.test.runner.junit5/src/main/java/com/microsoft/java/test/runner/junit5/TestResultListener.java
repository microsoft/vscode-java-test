...
public class TestResultListener implements TestExecutionListener {
    ...
    private final String TESTPLAN_EXECUTION_STARTED = "testPlanStarted";
    private final String TESTPLAN_EXECUTION_FINISHED = "testPlanFinished";
    private final String TEST_SKIPPED = "testSkipped";
    private final String TEST_STARTED = "testStarted";
    private final String TEST_FINISHED = "testFinished";
    ...
    public void testPlanExecutionStarted(TestPlan testPlan) {
        out.println(
                create(TESTPLAN_EXECUTION_STARTED,
                new Pair(NAME, testPlan.toString())));
    }

    @Override
    public void testPlanExecutionFinished(TestPlan testPlan) {
        out.println(
                create(TESTPLAN_EXECUTION_FINISHED,
                new Pair(NAME, testPlan.toString())));
    }
    ...
    public void executionSkipped(TestIdentifier testIdentifier, String reason) {
        out.println(
                create(TEST_SKIPPED,
                new Pair(ID, testIdentifier.getUniqueId()),
                new Pair(TYPE, testIdentifier.getType().toString()),
                new Pair(DETAILS, escape(reason))));
    }
